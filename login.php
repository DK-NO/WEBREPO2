...
<div class="formu2">
	...
	$sql=mysqli_query($link, "SELECT * FROM usuario WHERE correo='$correol'");
	if ($aux = mysqli_fetch_array($sql)) 
	{
		if ($x==$aux['contrasena2']) 
		{
				$_SESSION['nombre'] = $aux['nombre'];
			    $_SESSION['correo'] = $aux['correo'];
	...
	?>
	<br><br>
	<div class="iz"><a href="registro.php">registrase!</a></div>
	<div class="de"><a href="login.html">intenta otra vez?</a></div>
		</div>
